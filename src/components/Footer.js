        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="text-center lg:text-left">
                    <h3 className="text-lg font-semibold mb-4">DESA BANYUBIRU</h3>
                    <p className="text-gray-300">
                    Jl. Bhayangkara No.3, Randusari, Banyubiru, Kec. Banyubiru,
                    Kabupaten Semarang, Jawa Tengah 50664
                    </p>
                </div>
                ...
                <div className="text-center lg:text-left">
                    ...
                    <ul className="space-y-3 text-gray-300">
                        ...
                        <li className="flex items-center justify-center lg:justify-start space-x-3">
                            ...
                            <a href="mailto:kontak@banyubiru.desa.id" className="hover:text-white transition-colors">
                                kontak@banyubiru.desa.id
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="text-center lg:text-left">
                    ...
                    <div className="flex justify-center lg:justify-start space-x-4">
                        ...
                        <Link href="https://instagram.com" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                            <FaInstagram size={24} />
                        </Link>
                        <Link href="https://youtube.com" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                            <FaYoutube size={24} />
                        </Link>
                    </div>
                </div>
